...
class LiveStreamResponseMediaSource {
  /// Returns a new [LiveStreamResponseMediaSource] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LiveStreamResponseMediaSource &&
  ...
  /// Returns a new [LiveStreamResponseMediaSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static LiveStreamResponseMediaSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LiveStreamResponseMediaSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LiveStreamResponseMediaSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return LiveStreamResponseMediaSource(
  ...
  static List<LiveStreamResponseMediaSource>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <LiveStreamResponseMediaSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = LiveStreamResponseMediaSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, LiveStreamResponseMediaSource> mapFromJson(dynamic json) {
    final map = <String, LiveStreamResponseMediaSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LiveStreamResponseMediaSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of LiveStreamResponseMediaSource-objects as value to a dart map
  static Map<String, List<LiveStreamResponseMediaSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LiveStreamResponseMediaSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = LiveStreamResponseMediaSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
