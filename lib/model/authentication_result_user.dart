...
class AuthenticationResultUser {
  /// Returns a new [AuthenticationResultUser] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AuthenticationResultUser &&
     other.name == name &&
  ...
  /// Returns a new [AuthenticationResultUser] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AuthenticationResultUser? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AuthenticationResultUser[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AuthenticationResultUser[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AuthenticationResultUser(
  ...
  static List<AuthenticationResultUser>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AuthenticationResultUser>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AuthenticationResultUser.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AuthenticationResultUser> mapFromJson(dynamic json) {
    final map = <String, AuthenticationResultUser>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthenticationResultUser.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AuthenticationResultUser-objects as value to a dart map
  static Map<String, List<AuthenticationResultUser>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AuthenticationResultUser>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthenticationResultUser.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
