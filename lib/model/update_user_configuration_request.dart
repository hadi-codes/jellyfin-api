...
class UpdateUserConfigurationRequest {
  /// Returns a new [UpdateUserConfigurationRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateUserConfigurationRequest &&
  ...
  /// Returns a new [UpdateUserConfigurationRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdateUserConfigurationRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateUserConfigurationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateUserConfigurationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdateUserConfigurationRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UpdateUserConfigurationRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateUserConfigurationRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdateUserConfigurationRequest> mapFromJson(dynamic json) {
    final map = <String, UpdateUserConfigurationRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateUserConfigurationRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UpdateUserConfigurationRequest-objects as value to a dart map
  static Map<String, List<UpdateUserConfigurationRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateUserConfigurationRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateUserConfigurationRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
