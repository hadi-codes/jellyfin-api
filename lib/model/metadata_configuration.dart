...
class MetadataConfiguration {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (useFileCreationTimeForDateAdded != null) {
      _json[r'UseFileCreationTimeForDateAdded'] = useFileCreationTimeForDateAdded;
    } else {
      _json[r'UseFileCreationTimeForDateAdded'] = null;
    }
    return _json;
  }
  ...
  static Map<String, List<MetadataConfiguration>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MetadataConfiguration.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
