...
class ReportPlaybackStartRequest {
  /// Returns a new [ReportPlaybackStartRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ReportPlaybackStartRequest &&
  ...
  /// Returns a new [ReportPlaybackStartRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ReportPlaybackStartRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ReportPlaybackStartRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ReportPlaybackStartRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ReportPlaybackStartRequest(
  ...
  static List<ReportPlaybackStartRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ReportPlaybackStartRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ReportPlaybackStartRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ReportPlaybackStartRequest> mapFromJson(dynamic json) {
    final map = <String, ReportPlaybackStartRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ReportPlaybackStartRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ReportPlaybackStartRequest-objects as value to a dart map
  static Map<String, List<ReportPlaybackStartRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ReportPlaybackStartRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ReportPlaybackStartRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
