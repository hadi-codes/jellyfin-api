...
class SessionInfoNowPlayingItem {
  /// Returns a new [SessionInfoNowPlayingItem] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SessionInfoNowPlayingItem &&
     other.name == name &&
  ...
  /// Returns a new [SessionInfoNowPlayingItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SessionInfoNowPlayingItem? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SessionInfoNowPlayingItem[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SessionInfoNowPlayingItem[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SessionInfoNowPlayingItem(
  ...
  static List<SessionInfoNowPlayingItem>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SessionInfoNowPlayingItem>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SessionInfoNowPlayingItem.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SessionInfoNowPlayingItem> mapFromJson(dynamic json) {
    final map = <String, SessionInfoNowPlayingItem>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SessionInfoNowPlayingItem.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SessionInfoNowPlayingItem-objects as value to a dart map
  static Map<String, List<SessionInfoNowPlayingItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SessionInfoNowPlayingItem>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SessionInfoNowPlayingItem.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
