...
class UpdateUserPasswordRequest {
  ...
  @override
  String toString() => 'UpdateUserPasswordRequest[currentPassword=$currentPassword, currentPw=$currentPw, newPw=$newPw, resetPassword=$resetPassword]';
  ...
  static Map<String, List<UpdateUserPasswordRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateUserPasswordRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
