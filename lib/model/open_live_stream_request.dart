...
class OpenLiveStreamRequest {
  /// Returns a new [OpenLiveStreamRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OpenLiveStreamRequest &&
  ...
  /// Returns a new [OpenLiveStreamRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OpenLiveStreamRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OpenLiveStreamRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OpenLiveStreamRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<OpenLiveStreamRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OpenLiveStreamRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OpenLiveStreamRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OpenLiveStreamRequest> mapFromJson(dynamic json) {
    final map = <String, OpenLiveStreamRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OpenLiveStreamRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OpenLiveStreamRequest-objects as value to a dart map
  static Map<String, List<OpenLiveStreamRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OpenLiveStreamRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OpenLiveStreamRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
