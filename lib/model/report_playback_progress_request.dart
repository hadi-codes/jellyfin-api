...
class ReportPlaybackProgressRequest {
  /// Returns a new [ReportPlaybackProgressRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ReportPlaybackProgressRequest &&
  ...
  /// Returns a new [ReportPlaybackProgressRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ReportPlaybackProgressRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ReportPlaybackProgressRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ReportPlaybackProgressRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ReportPlaybackProgressRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ReportPlaybackProgressRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ReportPlaybackProgressRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ReportPlaybackProgressRequest> mapFromJson(dynamic json) {
    final map = <String, ReportPlaybackProgressRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ReportPlaybackProgressRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ReportPlaybackProgressRequest-objects as value to a dart map
  static Map<String, List<ReportPlaybackProgressRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ReportPlaybackProgressRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ReportPlaybackProgressRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
