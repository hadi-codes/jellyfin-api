...
class AddVirtualFolderDtoLibraryOptions {
  /// Returns a new [AddVirtualFolderDtoLibraryOptions] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AddVirtualFolderDtoLibraryOptions &&
  ...
  /// Returns a new [AddVirtualFolderDtoLibraryOptions] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AddVirtualFolderDtoLibraryOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AddVirtualFolderDtoLibraryOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AddVirtualFolderDtoLibraryOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AddVirtualFolderDtoLibraryOptions(
  ...
  static List<AddVirtualFolderDtoLibraryOptions>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AddVirtualFolderDtoLibraryOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AddVirtualFolderDtoLibraryOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AddVirtualFolderDtoLibraryOptions> mapFromJson(dynamic json) {
    final map = <String, AddVirtualFolderDtoLibraryOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AddVirtualFolderDtoLibraryOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AddVirtualFolderDtoLibraryOptions-objects as value to a dart map
  static Map<String, List<AddVirtualFolderDtoLibraryOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AddVirtualFolderDtoLibraryOptions>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AddVirtualFolderDtoLibraryOptions.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
