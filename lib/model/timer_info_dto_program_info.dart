...
class TimerInfoDtoProgramInfo {
  /// Returns a new [TimerInfoDtoProgramInfo] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TimerInfoDtoProgramInfo &&
     other.name == name &&
  ...
  /// Returns a new [TimerInfoDtoProgramInfo] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TimerInfoDtoProgramInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TimerInfoDtoProgramInfo[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TimerInfoDtoProgramInfo[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TimerInfoDtoProgramInfo(
  ...
  static List<TimerInfoDtoProgramInfo>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TimerInfoDtoProgramInfo>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TimerInfoDtoProgramInfo.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TimerInfoDtoProgramInfo> mapFromJson(dynamic json) {
    final map = <String, TimerInfoDtoProgramInfo>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TimerInfoDtoProgramInfo.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TimerInfoDtoProgramInfo-objects as value to a dart map
  static Map<String, List<TimerInfoDtoProgramInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TimerInfoDtoProgramInfo>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TimerInfoDtoProgramInfo.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
