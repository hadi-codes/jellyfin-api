...
class UtcTimeResponse {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (requestReceptionTime != null) {
      _json[r'RequestReceptionTime'] = requestReceptionTime!.toUtc().toIso8601String();
    } else {
      _json[r'RequestReceptionTime'] = null;
    }
    if (responseTransmissionTime != null) {
      _json[r'ResponseTransmissionTime'] = responseTransmissionTime!.toUtc().toIso8601String();
    } else {
      _json[r'ResponseTransmissionTime'] = null;
    }
    return _json;
  }
  ...
  static UtcTimeResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UtcTimeResponse(
        requestReceptionTime: mapDateTime(json, r'RequestReceptionTime', ''),
        responseTransmissionTime: mapDateTime(json, r'ResponseTransmissionTime', ''),
      );
    }
    return null;
  }
  ...
  static Map<String, List<UtcTimeResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UtcTimeResponse.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
