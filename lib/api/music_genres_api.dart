...
class MusicGenresApi {
  MusicGenresApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getMusicGenreWithHttpInfo(String genreName, { String? userId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/MusicGenres/{genreName}'
  ...
  Future<BaseItemDto?> getMusicGenre(String genreName, { String? userId, }) async {
    final response = await getMusicGenreWithHttpInfo(genreName,  userId: userId, );
