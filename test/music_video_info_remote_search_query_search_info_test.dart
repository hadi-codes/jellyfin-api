...
// tests for MusicVideoInfoRemoteSearchQuerySearchInfo
void main() {
  // final instance = MusicVideoInfoRemoteSearchQuerySearchInfo();

  group('test MusicVideoInfoRemoteSearchQuerySearchInfo', () {
