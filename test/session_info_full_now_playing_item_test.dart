...
// tests for SessionInfoFullNowPlayingItem
void main() {
  // final instance = SessionInfoFullNowPlayingItem();

  group('test SessionInfoFullNowPlayingItem', () {
    // int size
    ...
    // bool isShortcut
    test('to test the property `isShortcut`', () async {
      // TODO
    });

    // String shortcutPath
    test('to test the property `shortcutPath`', () async {
      // TODO
    });
    ...
    test('to test the property `dateLastSaved`', () async {
      // TODO
    });
