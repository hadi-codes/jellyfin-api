...
// tests for OpenLiveStreamRequest
void main() {
  // final instance = OpenLiveStreamRequest();

  group('test OpenLiveStreamRequest', () {
    ...
    // List<MediaProtocol> directPlayProtocols (default value: const [])
