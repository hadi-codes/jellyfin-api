...
// tests for AuthenticationResultSessionInfo
void main() {
  // final instance = AuthenticationResultSessionInfo();

  group('test AuthenticationResultSessionInfo', () {
    ...
    test('to test the property `remoteEndPoint`', () async {
      // TODO
    });
    ...
    test('to test the property `lastActivityDate`', () async {
      // TODO
    });

    // Gets or sets the last playback check in.
    // DateTime lastPlaybackCheckIn
    test('to test the property `lastPlaybackCheckIn`', () async {
      // TODO
    });
    ...
    test('to test the property `supportsRemoteControl`', () async {
      // TODO
    });
    ...
    test('to test the property `userPrimaryImageTag`', () async {
      // TODO
    });
